# Create a black sky in iPhone resolution

import matplotlib.pyplot as plt
import numpy as np

# Define the size of the image
width = 1290  # iPhone resolution width
height = 2796  # iPhone resolution height

# Create a black background
background = np.zeros((height, width, 3), dtype=np.uint8)

# Generate random stars
num_stars = 1500  # Number of stars
...
# Save the image
plt.imsave('black_star_sky_iPhone_realistic_stars.png', background)
